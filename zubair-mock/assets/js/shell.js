/* ==========================================================================
   The Zubair Corporation — Central E-Invoicing Hub — application shell + guided walkthrough
...
const ACTS = [
  { n: 'I',   t: 'It starts in their systems',         d: 'SAP for B2B, Autoline for high-volume B2C' },
...
const WALKTHROUGH = [
  ...
  { id: 'erp-invoices',  act: 0, sfc: 'erp',    href: '../erp/invoices.html',
    name: 'An invoice raised in the ERP',   blurb: 'A normal SAP billing document, B2B, created and posted as usual.' },
  { id: 'erp-counter',   act: 0, sfc: 'erp',    href: '../erp/counter.html',
    name: 'High-volume B2C, from Autoline', blurb: 'General Automotive’s counter and service sales, batched to the Hub.' },
  ...
  { id: 'hub-routing',   act: 4, sfc: 'hub',    href: '../hub/routing.html',
    name: 'Routed to the right entity',     blurb: 'Matched by Peppol participant and Commercial Registration.' },
  ...
  { id: 'hub-users',     act: 5, sfc: 'hub',    href: '../hub/users.html',
    name: 'Giving the company its own login', blurb: 'How each of the twelve gets access, and who administers it.' },
  ...
  { id: 'portal-home',   act: 5, sfc: 'portal', href: '../portal/dashboard.html',
    name: 'What that company sees',         blurb: 'Only its own data. The other eleven are invisible.' },
...
const NAV = {
  hub: [
    { label: 'Operations', items: [
      ...
      { key: 'routing',   name: 'Inbound Routing',    href: 'routing.html',   ico: 'send' },
    ...
    { label: 'Configuration', items: [
      { key: 'tenants',   name: 'Companies',          href: 'tenants.html',   ico: 'tenants', tag: '12' },
  ...
  erp: [
    { label: 'Accounts Receivable', items: [
      { key: 'invoices',  name: 'Billing Documents',  href: 'invoices.html', ico: 'file' },
...
const BRAND = {
  hub:    { mark: 'Z', name: 'The Zubair Corporation', sub: 'Central E-Invoicing Hub', who: 'ZG', whoName: 'Group IT',      whoRole: 'Platform administrator' },
  erp:    { mark: 'Z', name: 'The Zubair Corporation LLC', sub: 'SAP S/4HANA',        who: 'AB', whoName: 'A. Al-Balushi', whoRole: 'Accounts Receivable' },
  portal: { mark: 'Z', name: 'The Zubair Corporation LLC', sub: 'Entity Portal',       who: 'NK', whoName: 'N. Al-Kindi',   whoRole: 'Finance — one company' }
};

const ENV = { hub: 'Central Hub', erp: 'SAP S/4HANA', portal: 'One company' };
...
const RAIL_KEY = 'zubair.hub.rail.';

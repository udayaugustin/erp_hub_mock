/* ==========================================================================
   OIB Group — Central E-Invoicing Hub — application shell + guided walkthrough
...
const WALKTHROUGH = [
  ...
  { id: 'erp-counter',   act: 0, sfc: 'erp',    href: '../erp/counter.html',
    name: 'High-volume B2C, from High-Volume Billing', blurb: 'OIB Digital Payments’s counter and service sales, batched to the Hub.' },
...
const BRAND = {
  hub:    { mark: 'O', name: 'OIB Group', sub: 'Central E-Invoicing Hub', who: 'OG', whoName: 'Group IT',      whoRole: 'Platform administrator' },
  erp:    { mark: 'O', name: 'Oman Investment Bank SAOC', sub: 'Enterprise ERP',        who: 'AB', whoName: 'A. Al-Balushi', whoRole: 'Accounts Receivable' },
  portal: { mark: 'O', name: 'Oman Investment Bank SAOC', sub: 'Entity Portal',       who: 'NK', whoName: 'N. Al-Kindi',   whoRole: 'Finance — one company' }
};

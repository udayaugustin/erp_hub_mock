/* ==========================================================================
   The ABC Group — Central E-Invoicing Hub · demonstration dataset

   The twelve entities are ILLUSTRATIVE members of ONE Oman VAT Group — The
   ABC Group VAT Group, TRN OM1200094685. The names (ABC, XYZ, BCD …) are
...
/* --- entities --------------------------------------------------------------
   Twelve members of The ABC Group VAT Group (TRN OM1200094685).
...
const TENANTS = [
  {
    id: 'ABC', code: 'GRP-001', name: 'ABC Trading LLC', short: 'ABC Trading',
  ...
  {
    id: 'XYZ', code: 'GRP-002', name: 'XYZ Industries LLC', short: 'XYZ Industries',
  ...
  {
    id: 'BCD', code: 'GRP-003', name: 'BCD Services LLC', short: 'BCD Services',
  ...
  {
    id: 'DEF', code: 'GRP-004', name: 'DEF Properties LLC', short: 'DEF Properties',
  ...
  {
    id: 'GHI', code: 'GRP-005', name: 'GHI Building Solutions LLC', short: 'GHI Building',
  ...
  {
    id: 'JKL', code: 'GRP-006', name: 'JKL Logistics LLC', short: 'JKL Logistics',
  ...
  {
    id: 'MNO', code: 'GRP-007', name: 'MNO Automotive LLC', short: 'MNO Automotive',
  ...
  {
    id: 'STU', code: 'GRP-008', name: 'STU Motors LLC', short: 'STU Motors',
  ...
  {
    id: 'PQR', code: 'GRP-009', name: 'PQR Retail Group LLC', short: 'PQR Retail',
    ...
    note: 'Highest-volume member — showroom, parts and service counters. Simplified B2C invoices are reported to the OTA in batches from High-Volume Billing, not cleared live at point of sale.'
  },
  {
    id: 'YZA', code: 'GRP-010', name: 'YZA Heavy Equipment LLC', short: 'YZA Heavy Equipment',
  ...
  {
    id: 'VWX', code: 'GRP-011', name: 'VWX Enterprises LLC', short: 'VWX Enterprises',
  ...
  {
    id: 'RST', code: 'GRP-012', name: 'RST Retail LLC', short: 'RST Retail',
...
const WAVES = [
  { n: 1, name: 'Live pilot', window: 'Live since Jun 2026', entities: 5, live: 5, state: 'complete',
    note: 'Enterprise ERP corporate entities and PQR Retail — the volume proof. Validates the model before the mandate.' },
  { n: 2, name: 'Wave 2', window: 'Cutover Q4 2026', entities: 5, live: 5, state: 'active',
    note: 'High-Volume Billing dealerships, Finance Suite and Accounting System. Mapping complete, running in parallel.' },
...
/* --- the second origin: high-volume B2C from High-Volume Billing ----------------------
   PQR Retail Group (PQR) runs High-Volume Billing. Its showroom, parts
   counter and workshop generate the group's biggest B2C stream — thousands of
   Simplified invoices a day. They are collected by High-Volume Billing and reported to
   the OTA in BATCHES through the same Central Hub, not cleared live at the
   counter. The batch cadence is an assumption to confirm with the group.        */
const RETAIL_B2C = {
  entity: 'PQR', system: 'High-Volume Billing', release: 'Rev8',
  module: 'Retail & Service — Simplified invoicing',
  todayCount: 3105, monthCount: 66136, awaitingSync: 38, counters: 4,
  batch: { id: 'PQR-B2C-2026-0818-14', count: 480, syncedAt: '10:30 GST',
  ...
  note: 'Simplified B2C invoices are collected by High-Volume Billing and reported to the OTA in scheduled batches from the Central Hub — not cleared live at the point of sale.',
  assumption: 'Assumption · to confirm with the group: batch cadence and whether any counter requires a cleared invoice before the customer leaves.',
  rows: [
    { no: 'PQR-SIMP-2026-441207', ctr: 'Ghala Parts Counter', cust: 'Walk-in Customer', item: 'Brake pad set', net: 84.400,  vat: 4.220,  total: 88.620,  t: '10:18', state: 'reported' },
    { no: 'PQR-SIMP-2026-441208', ctr: 'Rusayl Service',      cust: 'Walk-in Customer', item: 'Oil change service', net: 32.000, vat: 1.600, total: 33.600, t: '10:19', state: 'reported' },
    { no: 'PQR-SIMP-2026-441209', ctr: 'Wattayah Showroom',   cust: 'Walk-in Customer', item: 'Accessory pack',    net: 145.000, vat: 7.250, total: 152.250, t: '10:21', state: 'batched' },
    { no: 'PQR-SIMP-2026-441210', ctr: 'Ghala Parts Counter', cust: 'Walk-in Customer', item: 'Air filter',        net: 12.500,  vat: 0.625, total: 13.125,  t: '10:22', state: 'batched' },
    { no: 'PQR-SIMP-2026-441211', ctr: 'Rusayl Service',      cust: 'Al Batinah Logistics Services LLC', item: 'Tyre replacement ×4', net: 210.000, vat: 10.500, total: 220.500, t: '10:24', state: 'queued' },
    { no: 'PQR-SIMP-2026-441212', ctr: 'Wattayah Showroom',   cust: 'Walk-in Customer', item: 'Car mats & trim',   net: 58.000,  vat: 2.900, total: 60.900,  t: '10:25', state: 'queued' },
    { no: 'PQR-SIMP-2026-441213', ctr: 'Ghala Parts Counter', cust: 'Walk-in Customer', item: 'Wiper blades',      net: 9.000,   vat: 0.450, total: 9.450,   t: '10:26', state: 'queued' },
    { no: 'PQR-SIMP-2026-441214', ctr: 'Sohar Branch',        cust: 'Walk-in Customer', item: 'AC re-gas',         net: 25.000,  vat: 1.250, total: 26.250,  t: '10:27', state: 'queued' }
  ]
};
...
/* --- outbound documents ----------------------------------------------------
   ...
   The tracked invoice ABC-SINV-2026-00841 (ABC Trading LLC, Enterprise ERP
   Enterprise ERP) is the one followed end-to-end through the walkthrough.          */
const INVOICES = [
  { no: 'ABC-SINV-2026-00841', tenant: 'ABC', cust: 0, net: 48200.000, vat: 2410.000, total: 50610.000,
    ...
    lines: 6, po: 'PO-88213' },
  { no: 'PQR-SINV-2026-118420', tenant: 'PQR', cust: 1, net: 118400.000, vat: 5920.000, total: 124320.000,
  ...
  { no: 'JKL-SINV-2026-08810', tenant: 'JKL', cust: 3, net: 86200.000, vat: 0.000, total: 86200.000,
  ...
  { no: 'GHI-SINV-2026-00934', tenant: 'GHI', cust: 4, net: 3420.000, vat: 171.000, total: 3591.000,
    ...
    owner: 'entity' },
  { no: 'PQR-SINV-2026-118455', tenant: 'PQR', cust: 6, net: 9150.000, vat: 457.500, total: 9607.500,
  ...
  { no: 'ABC-CRNT-2026-00218', tenant: 'ABC', cust: 0, net: -4200.000, vat: -210.000, total: -4410.000,
    ...
    lines: 1, po: null, against: 'ABC-SINV-2026-00790' },
  { no: 'PQR-SIMP-2026-441207', tenant: 'PQR', cust: 5, net: 84.400, vat: 4.220, total: 88.620,
    ...
    lines: 5, po: null },
  { no: 'YZA-SINV-2026-00611', tenant: 'YZA', cust: 7, net: 42750.000, vat: 2137.500, total: 44887.500,
  ...
  { no: 'BCD-SINV-2026-01181', tenant: 'BCD', cust: 2, net: 15600.000, vat: 780.000, total: 16380.000,
  ...
  { no: 'RST-SINV-2026-02673', tenant: 'RST', cust: 6, net: 7480.000, vat: 374.000, total: 7854.000,
  ...
  { no: 'STU-SINV-2026-03408', tenant: 'STU', cust: 4, net: 12900.000, vat: 645.000, total: 13545.000,
  ...
  { no: 'JKL-SINV-2026-08790', tenant: 'JKL', cust: 3, net: 28700.000, vat: 0.000, total: 28700.000,
    ...
    owner: 'platform' },
  { no: 'YZA-SINV-2026-00610', tenant: 'YZA', cust: 5, net: 1890.000, vat: 94.500, total: 1984.500,
...
/* --- ERP-side invoice list (screen 1 · Enterprise ERP, ABC Trading LLC) -- */
const ERP_INVOICES = [
  { no: 'ABC-SINV-2026-00841', cust: 'Muscat Bay Hospitality LLC', date: '18-08-2026', due: '17-09-2026',
    net: 48200.000, vat: 2410.000, total: 50610.000, docStatus: 'Posted', eStatus: 'Acknowledged',
    ready: true, uuid: 'b7f4c2e1…0a35', qr: true },
  { no: 'ABC-SINV-2026-00840', cust: 'Sohar Steel Rolling LLC', date: '18-08-2026', due: '17-09-2026',
    net: 118400.000, vat: 5920.000, total: 124320.000, docStatus: 'Posted', eStatus: 'Acknowledged',
    ready: true, uuid: 'c1a8d3f2…1b46', qr: true },
  { no: 'ABC-SINV-2026-00842', cust: 'Salalah Port Services SAOC', date: '18-08-2026', due: '17-09-2026',
    net: 7480.000, vat: 374.000, total: 7854.000, docStatus: 'Posted', eStatus: 'In Progress',
    ready: true, uuid: null, qr: false },
  { no: 'ABC-CRNT-2026-00218', cust: 'Muscat Bay Hospitality LLC', date: '18-08-2026', due: '—',
  ...
  { no: 'ABC-SINV-2026-00843', cust: 'Nizwa Auto Spares LLC', date: '18-08-2026', due: '17-09-2026',
    net: 33150.000, vat: 1657.500, total: 34807.500, docStatus: 'Draft', eStatus: 'Not Applicable',
    ready: false, uuid: null, qr: false },
  { no: 'ABC-SINV-2026-00839', cust: 'Directorate General of Roads', date: '17-08-2026', due: '16-09-2026',
    net: 51200.000, vat: 2560.000, total: 53760.000, docStatus: 'Posted', eStatus: 'Acknowledged',
    ready: true, uuid: 'd4c1b8a7…3e92', qr: true },
  { no: 'ABC-SINV-2026-00838', cust: 'Sohar Steel Rolling LLC', date: '17-08-2026', due: '16-09-2026',
...
/* --- processing logs -------------------------------------------------------- */
const LOGS = [
  { ts: '10:22:28.114', lv: 'info', txt: 'Poll tick — entity ABC, watermark 2026-08-18T10:21:44Z' },
  { ts: '10:22:28.291', lv: 'info', txt: 'Fetched raw payload · 14.2 KB · 27 fields (allowlist applied)' },
  { ts: '10:22:28.402', lv: 'ok',   txt: 'Idempotency check passed — (ABC, ABC-SINV-2026-00841) not previously seen' },
  { ts: '10:22:28.556', lv: 'info', txt: 'Mapping profile ABC/v3 applied — 46 of 47 fields resolved' },
  ...
  { ts: '10:22:31.788', lv: 'ok',   txt: 'State → READY_FOR_ASP · queued on entity channel ABC' }
];
...
/* --- history ---------------------------------------------------------------- */
const HISTORY = [
  { no: 'ABC-SINV-2026-00841', tenant: 'ABC', date: '18 Aug 09:14', total: 50610.000, type: 'Invoice',  dir: 'out', st: 'success', ack: 'ASP-OM-2026-0818-44718', retries: 0 },
  { no: 'PQR-SINV-2026-118420', tenant: 'PQR', date: '18 Aug 09:21', total: 124320.000, type: 'Invoice', dir: 'out', st: 'success', ack: 'ASP-OM-2026-0818-44719', retries: 0 },
  { no: 'YZA-SINV-2026-00610', tenant: 'YZA', date: '18 Aug 08:14', total: 1984.500, type: 'Simplified', dir: 'out', st: 'success', ack: 'ASP-OM-2026-0818-44702', retries: 0 },
  { no: 'JKL-SINV-2026-08790', tenant: 'JKL', date: '18 Aug 08:52', total: 28700.000, type: 'Invoice',  dir: 'out', st: 'failed',  ack: null, retries: 4, err: 'ASP timeout — transient, retrying' },
  { no: 'ABC-CRNT-2026-00218', tenant: 'ABC', date: '18 Aug 10:26', total: -4410.000, type: 'Credit Note', dir: 'out', st: 'success', ack: 'ASP-OM-2026-0818-44736', retries: 0 },
  { no: 'FIS-INV-2026-11842',  tenant: 'ABC', date: '18 Aug 10:29', total: 9072.000, type: 'Supplier invoice', dir: 'in', st: 'success', ack: 'PINV-2026-00914', retries: 0 },
  { no: 'RMC-INV-2026-00733',  tenant: 'PQR', date: '18 Aug 10:24', total: 22575.000, type: 'Supplier invoice', dir: 'in', st: 'success', ack: 'PINV-ATL-004411', retries: 0 },
  { no: 'PQR-SIMP-2026-441207', tenant: 'PQR', date: '18 Aug 10:18', total: 88.620, type: 'Simplified',  dir: 'out', st: 'success', ack: 'ASP-OM-2026-0818-44731', retries: 0 },
  { no: 'GHI-SINV-2026-00934', tenant: 'GHI', date: '18 Aug 10:11', total: 3591.000, type: 'Invoice',   dir: 'out', st: 'failed',  ack: null, retries: 2, err: 'IBR-CO-15 · total mismatch' },
  { no: 'BCD-SINV-2026-01179', tenant: 'BCD', date: '18 Aug 07:40', total: 44210.000, type: 'Invoice',  dir: 'out', st: 'reprocessed', ack: 'ASP-OM-2026-0818-44688', retries: 1 },
  { no: 'ABC-SINV-2026-00838', tenant: 'ABC', date: '17 Aug 16:22', total: 7665.000, type: 'Invoice',   dir: 'out', st: 'rejected', ack: null, retries: 0, err: 'ASP rejected — buyer participant not registered' },
  { no: 'MTB-CRN-2026-00318',  tenant: 'PQR', date: '18 Aug 09:58', total: -1312.500, type: 'Supplier credit note', dir: 'in', st: 'success', ack: 'PCRN-ATL-00072', retries: 0 },
  { no: 'JKL-SINV-2026-08810', tenant: 'JKL', date: '18 Aug 10:02', total: 86200.000, type: 'Invoice',  dir: 'out', st: 'pending', ack: null, retries: 0 },
  { no: 'YZA-SINV-2026-00611', tenant: 'YZA', date: '18 Aug 10:22', total: 44887.500, type: 'Invoice',  dir: 'out', st: 'pending', ack: null, retries: 0 },
  { no: 'ABC-SINV-2026-00839', tenant: 'ABC', date: '17 Aug 14:11', total: 53760.000, type: 'Invoice',  dir: 'out', st: 'success', ack: 'ASP-OM-2026-0817-44590', retries: 0 }
];
...
/* --- reporting -------------------------------------------------------------
   ...
   vat = (net − zero) × 5%.                                                  */
const REPORT_ROWS = [
  { id: 'PQR', docs: 41000, net: 4180000.000, vat: 203000.000, zero: 120000.000, failed: 300, ack: 40700 },
  { id: 'YZA', docs: 2700,  net: 1240000.000, vat: 59000.000,  zero: 60000.000,  failed: 22,  ack: 2678 },
  { id: 'RST', docs: 2650,  net: 980000.000,  vat: 48000.000,  zero: 20000.000,  failed: 20,  ack: 2630 },
  { id: 'JKL', docs: 880,   net: 1610000.000, vat: 70000.000,  zero: 210000.000, failed: 12,  ack: 868 },
  { id: 'STU', docs: 340,   net: 612000.000,  vat: 30200.000,  zero: 8000.000,   failed: 6,   ack: 334 },
  { id: 'ABC', docs: 96,    net: 486000.000,  vat: 24300.000,  zero: 0.000,      failed: 0,   ack: 96 }
];
...
const ENTITY_USERS = [
  { name: 'N. Al-Kindi',   email: 'n.alkindi@abcgroup.example',   role: 'entity-admin', state: 'active',  last: 'Today 10:31', who: 'ABC' },
  { name: 'F. Al-Harthy',  email: 'f.alharthy@abcgroup.example',  role: 'finance',      state: 'active',  last: 'Today 09:48', who: 'ABC' },
  { name: 'R. Menon',      email: 'r.menon@abcgroup.example',     role: 'finance',      state: 'active',  last: 'Yesterday',   who: 'ABC' },
  { name: 'S. Al-Zadjali', email: 's.alzadjali@abcgroup.example', role: 'readonly',     state: 'active',  last: '3 days ago',  who: 'ABC' },
  { name: 'A. Baloushi',   email: 'a.baloushi@abcgroup.example',  role: 'finance',      state: 'invited', last: 'Invited today', who: 'ABC' }
];
...
/* --- group activity feed ---------------------------------------------------- */
const ACTIVITY = [
  { st: 'ok',   t: '10:35', title: 'Acknowledgement received', body: 'RST-SINV-2026-02671 · reported to the OTA', tag: 'RST Retail' },
  { st: 'fail', t: '10:11', title: 'Validation failed', body: 'GHI-SINV-2026-00934 · IBR-CO-15 total mismatch', tag: 'GHI Building' },
  { st: 'ok',   t: '10:29', title: 'Supplier invoice drafted', body: 'FIS-INV-2026-11842 · draft PINV-2026-00914 awaiting review', tag: 'ABC Trading' },
  { st: 'warn', t: '09:58', title: 'Connector latency elevated', body: 'High-Volume Billing extract p95 at 3.4 s — above the 2 s threshold', tag: 'PQR Retail' },
  { st: 'warn', t: '08:22', title: 'No documents received', body: 'Nothing since 04:38 from the High-Volume Billing connector.', tag: 'VWX Enterprises' },
  { st: 'ok',   t: '09:40', title: 'Mapping profile published', body: 'MNO Automotive v3 — 43 of 46 fields resolved', tag: 'MNO Automotive' }
];

/* --- exceptions, split by who owns the fix (proposal §7) -------------------- */
/* Entity-owned exceptions, shown to the entity in its own portal. These are
   ABC Trading LLC's (ABC) own documents — the portal shows nothing
   belonging to any other member. */
const EXCEPTIONS_ENTITY = [
  { title: 'Buyer VAT number missing', count: 2, docs: ['ABC-SINV-2026-00842', 'ABC-SINV-2026-00844'],
  ...
  { title: 'Invoice total does not add up', count: 1, docs: ['ABC-SINV-2026-00845'],
...
const EXCEPTIONS_PLATFORM = [
  ...
  { title: 'Connector went quiet', count: 1, who: 'Central technical team',
    why: 'VWX Enterprises has sent nothing since 04:38. The High-Volume Billing connector appears not to have run.',
...
const SYNC_STEPS = [
  { name: 'Invoice posted in the ERP', t: '18 Aug 09:14:02', st: 'ok',
    body: 'Billing document ABC-SINV-2026-00841 posted by A. Al-Balushi in Enterprise ERP. Document status set to Posted.' },
  ...
  { name: 'Mapped, built and validated', t: '18 Aug 09:14:06', st: 'ok',
    body: 'Profile ABC/v3 applied. UBL 2.1 built. Oman CIUS Schematron passed — 148 rules, 2 warnings.' },

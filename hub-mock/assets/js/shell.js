/* ==========================================================================
   The ABC Group — Central E-Invoicing Hub — application shell + guided walkthrough
...
const WALKTHROUGH = [
  ...
  { id: 'erp-counter',   act: 0, sfc: 'erp',    href: '../erp/counter.html',
    name: 'High-volume B2C, from High-Volume Billing', blurb: 'PQR Retail’s counter and service sales, batched to the Hub.' },
...
const BRAND = {
  hub:    { mark: 'A', name: 'The ABC Group', sub: 'Central E-Invoicing Hub', who: 'AG', whoName: 'Group IT',      whoRole: 'Platform administrator' },
  erp:    { mark: 'A', name: 'ABC Trading LLC', sub: 'Enterprise ERP',        who: 'AB', whoName: 'A. Al-Balushi', whoRole: 'Accounts Receivable' },
  portal: { mark: 'A', name: 'ABC Trading LLC', sub: 'Entity Portal',       who: 'NK', whoName: 'N. Al-Kindi',   whoRole: 'Finance — one company' }
};

/* ==========================================================================
   Integrated Gas Company × Fawtara — E-Invoicing Scope Walkthrough — application shell
   Injects sidebar, topbar (with step navigation), hint strip and footer.
   Configured by data-* attributes on <body>:
     data-surface  hub | erp   (erp = IGC's generic Enterprise ERP)
   ...
   The spine is the SIX invoice streams, not a roster of companies — IGC is
   one legal entity. Open tax treatments are flagged "to confirm".
   ========================================================================== */
...
const ACTS = [
  ...
  { n: 'II',  t: 'IGC as seller — long-term gas sales', d: 'A monthly gas invoice, cleared to the OTA end to end' },
  { n: 'III', t: 'IGC as seller — volume, spot, true-ups', d: 'Metered billing, spot sales, credit and debit notes' },
  { n: 'IV',  t: 'The open questions',                  d: 'Export, government allocation and take-or-pay — Fawtara’s reading' },
  { n: 'V',   t: 'As buyer, and the record',            d: 'Producer and transporter invoices, reports and value' }
];

const WALKTHROUGH = [
  /* Act I */
  { id: 'hub-login',     act: 0, sfc: 'hub', href: '../hub/login.html',
    name: 'Signing in to the console',       blurb: 'The IGC e-invoicing team logs in.' },
  { id: 'hub-dashboard', act: 0, sfc: 'hub', href: '../hub/dashboard.html',
    name: 'All six streams on one screen',   blurb: 'Purchase, transport, long-term and spot sales, adjustments, export — volumes and health.' },

  /* Act II — long-term gas sale: the canonical clear-to-OTA flow */
  { id: 'erp-billing',   act: 1, sfc: 'erp', href: '../origin/billing.html',
    name: 'A long-term gas sales invoice',   blurb: 'Raised in the Enterprise ERP, posted as usual.' },
  ...
  /* Act III — volume billing, spot sales, adjustments */
  { id: 'erp-nominations', act: 2, sfc: 'erp', href: '../origin/nominations.html',
    name: 'Monthly billing from metered volumes', blurb: 'Nominations, metered MMBtu, take-or-pay and price — through to the invoice.' },
  { id: 'hub-adjustments', act: 2, sfc: 'hub', href: '../hub/adjustments.html',
    name: 'Spot sales and true-up notes',    blurb: 'A one-off spot invoice, and credit and debit notes that reference the original.' },

  /* Act IV — the unsettled treatments, with Fawtara's recommended reading */
  { id: 'hub-export',    act: 3, sfc: 'hub', href: '../hub/export.html',
    name: 'Export and government allocation', blurb: 'Zero-rated at 0% with a reason code. Fawtara’s reading, to confirm with OTA.' },
  { id: 'hub-takeorpay', act: 3, sfc: 'hub', href: '../hub/takeorpay.html',
    name: 'Take-or-pay shortfall',           blurb: 'Consideration or compensation? To confirm with OTA.' },

  /* Act V — IGC as buyer, the record, and the value */
  { id: 'hub-inbound',   act: 4, sfc: 'hub', href: '../hub/inbound.html',
    name: 'Producer and transporter invoices, in', blurb: 'Gas purchase and transportation invoices land as drafts in the ERP.' },
  { id: 'hub-reports',   act: 4, sfc: 'hub', href: '../hub/reports.html',
    name: 'Reports and reconciliation',      blurb: 'VAT by stream, billing-run reconciliation, the position register.' },
  { id: 'hub-value',     act: 4, sfc: 'hub', href: '../hub/value.html',
    name: 'Why Fawtara',                     blurb: 'Accreditation, Oman data residency, volume-based billing.' },
...
const NAV = {
  hub: [
    { label: 'Operations', items: [
      ...
      { key: 'adjustments', name: 'Spot & true-ups',  href: 'adjustments.html', ico: 'refresh' },
      { key: 'inbound',   name: 'Inbound purchases',      href: 'inbound.html',   ico: 'inbox' },
      { key: 'asp',       name: 'ASP Exchange',       href: 'asp.html',       ico: 'send' }
    ]},
    { label: 'OTA positions', items: [
      { key: 'export',    name: 'Export & allocation', href: 'export.html',    ico: 'doc', tag: 'TBC' },
      { key: 'takeorpay', name: 'Take-or-pay',        href: 'takeorpay.html', ico: 'doc', tag: 'TBC' }
    ]},
    { label: 'Records', items: [
  ...
  erp: [
    { label: 'Gas sales', items: [
      { key: 'billing',   name: 'Gas Sales Invoices',       href: 'billing.html',  ico: 'file' },
      { key: 'nominations', name: 'Nominations & Billing', href: 'nominations.html', ico: 'users' },
...
const BRAND = {
  hub: { mark: 'I', name: 'IGC', sub: 'E-Invoicing Console', who: 'IT', whoName: 'E-Invoicing team', whoRole: 'Fawtara administrator' },
  erp: { mark: 'I', name: 'IGC', sub: 'Enterprise ERP', who: 'BR', whoName: 'Gas sales billing', whoRole: 'Revenue & billing' }
};
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  footer.innerHTML = `
    <span>Demonstration prototype — IGC is real; every figure, counterparty and treatment is illustrative</span>

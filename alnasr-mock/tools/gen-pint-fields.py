...
whenever core/data/pint_om_invoice_v1.json changes:
    ...
    python3 alnasr-mock/tools/gen-pint-fields.py
...
MOCK = pathlib.Path(__file__).resolve().parents[1]      # alnasr-mock/
OUT = MOCK / "assets" / "js" / "pint-fields.js"

# The ruleset lives in the e-invoicing suite, not in the mock. Try the usual
# places, and accept an explicit path as argv[1] when the layout differs.
CANDIDATES = [
    MOCK.parents[1] / "oman-einvoice-suite" / "core" / "data" / "pint_om_invoice_v1.json",
    MOCK.parents[1] / "core" / "data" / "pint_om_invoice_v1.json",
    MOCK.parent / "core" / "data" / "pint_om_invoice_v1.json",
]
...
# ANM-SINV-2026-01184. Keyed by IBT so they survive a ruleset rename.
# Anything absent renders as "not applicable on this invoice".
#
# `ERP_SRC` is the field name on the ERP side. Al Nasr Marbles runs ERPNext in
...
# Set by the Hub for every document, identical across all 11 entities.
# Not read from an ERP and not derived from invoice data.
HUB_SET = {"IBT-023", "IBT-024"}

VALUES = {
    "IBT-001": "ANM-SINV-2026-01184",
    "BTOM-002": "a4e91b73-2c6d-5f80-9b4a-1e7c3d05f862",
    "IBT-002": "2026-07-28",
    "IBT-003": "380",
    "BTOM-001": "Standard",
    "IBT-005": "OMR",
    ...
    "IBT-009": "2026-08-27",
    "IBT-013": "PO-3341",
    "IBT-022": "Royal Beige slab order, Muscat Bay site",
    "IBT-024": "urn:peppol:pint:billing-1@om-1",
    "IBT-023": "urn:peppol:bis:billing",
    # seller
    "IBT-027": "Al Nasr Marbles LLC",
    "IBT-028": "Al Nasr Marbles",
    "IBT-029": "OM1100381742",
    "IBT-030": "1146082",
    "IBT-031": "OM1100381742",
    "IBT-033": "Al Nasr Group of Companies entity",
    "IBT-035": "Darsait, Way 3011",
    "IBT-037": "Darsait",
    "IBT-038": "100",
    "IBT-039": "Muscat Governorate",
    "IBT-040": "OM",
    # buyer
    "IBT-044": "MUSCAT BAY DEVELOPMENTS LLC",
    "IBT-046": "CUST-004182",
    "IBT-047": "1104477",
    "IBT-048": "OM1100112233",
    "IBT-049": "accounts@muscatbaydev.om",
    ...
    "IBT-131": "24800.000",
    "IBT-146": "206.667",
    "IBT-153": "AM Royal Beige, polished slab 20 mm",
    "IBT-154": "Omani marble slab, polished finish, 20 mm thickness",
    "IBT-155": "AM-RB-POL-20",
    "IBT-151": "S",
    "IBT-152": "5.00",
}
...
def main() -> int:
   ...
   Regenerate: python3 alnasr-mock/tools/gen-pint-fields.py
...
"""
    ...
    print(f"wrote {OUT.relative_to(MOCK)}")

...
| 3 | Systems | The Group's actual ERP/billing stack is shown generically (Enterprise ERP, Field Operations System, Finance Suite, Accounting System); not named | Ras Al Hamra Group |
...
Public information only — Ras Al Hamra Group's own website (rasalhamra.com) and public
...
Projects & Products, Digital Transformation). No confidential or internal information
was used or assumed.

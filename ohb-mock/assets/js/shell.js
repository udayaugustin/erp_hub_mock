/* ==========================================================================
   Oman Housing Bank — Central E-Invoicing Hub — application shell + guided walkthrough
...
const ACTS = [
  { n: 'I',   t: 'It starts in their systems',         d: 'Enterprise ERP for B2B, High-Volume Billing for high-volume B2C' },
...
const WALKTHROUGH = [
  ...
  { id: 'erp-counter',   act: 0, sfc: 'erp',    href: '../erp/counter.html',
    name: 'High-volume B2C, from High-Volume Billing', blurb: 'OHB Customer Experience’s counter and service sales, batched to the Hub.' },
...
const BRAND = {
  hub:    { mark: 'O', name: 'Oman Housing Bank', sub: 'Central E-Invoicing Hub', who: 'OG', whoName: 'Group IT',      whoRole: 'Platform administrator' },
  erp:    { mark: 'O', name: 'Oman Housing Bank SAOC', sub: 'Enterprise ERP',        who: 'AB', whoName: 'A. Al-Balushi', whoRole: 'Accounts Receivable' },
  portal: { mark: 'O', name: 'Oman Housing Bank SAOC', sub: 'Entity Portal',       who: 'NK', whoName: 'N. Al-Kindi',   whoRole: 'Finance — one company' }
};

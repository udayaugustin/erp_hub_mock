/* ==========================================================================
   National Detergent Co E-Invoicing — application shell + guided walkthrough
...
const ACTS = [
  { n: 'I',   t: 'It starts in your systems',           d: 'Dynamics invoices and FieldAssist van sales — nothing about how you work changes' },
...
const WALKTHROUGH = [
  ...
  { id: 'erp-invoices',  act: 0, sfc: 'erp',    href: '../erp/invoices.html',
    name: 'An invoice raised in Dynamics',  blurb: 'A normal customer invoice, created and posted as usual.' },
  { id: 'erp-fieldassist', act: 0, sfc: 'erp', href: '../erp/fieldassist.html',
    name: 'A van sale from FieldAssist',    blurb: 'Van invoices sync into Dynamics, then ride the same one pipe to the OTA.' },
...
const NAV = {
  ...
  erp: [
    { label: 'Accounts Receivable', items: [
      { key: 'invoices',  name: 'Customer Invoices',  href: 'invoices.html',     ico: 'file' },
      { key: 'fieldassist', name: 'Van Sales · FieldAssist', href: 'fieldassist.html', ico: 'inbox' },
      { key: 'customers', name: 'Customers',          href: '#',             ico: 'users' },
      { key: 'payments',  name: 'Payment Journal',    href: '#',             ico: 'chart' }
    ]},
...
const BRAND = {
  hub:    { mark: 'N', name: 'National Detergent Co',  sub: 'E-Invoicing',          who: 'AN', whoName: 'A. Al-Nabhani', whoRole: 'Compliance administrator' },
  erp:    { mark: 'N', name: 'National Detergent Co',  sub: 'Microsoft Dynamics 365', who: 'SR', whoName: 'S. Al-Rashdi',  whoRole: 'Accounts Receivable' },
  portal: { mark: 'N', name: 'National Detergent Co',  sub: 'Finance view',         who: 'HH', whoName: 'H. Al-Hinai',   whoRole: 'Finance' }
};

const ENV = { hub: 'Compliance system', erp: 'Dynamics 365', portal: 'Finance view' };
